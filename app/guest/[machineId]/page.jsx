...
import { getMachineByIdNoAuth, getMachineImageNoAuth, getMachineTagNoAuth, getMachineCertificateNoAuth } from '../../../api/machine';
...
const downloadCertificate = (extension) => {
  getMachineCertificateNoAuth(currentMachine._id)
            .then(response => {
                ...
                <div className='col-md-6'>
                  <div className='align-items-center justify-content-center'>
                    <div className='img-fluid mb-4'>
                      <MachineGuestImages alt={currentMachine?.nomMaquina} getImage={getMachineImageNoAuth} param={currentMachine?._id} status={currentMachine?.foto_equipo ? true : false} width={'500px'} height={'300px'} />
                    </div>
                  </div>
                </div>
                <div className='col-md-6'>
                  <div className='align-items-center justify-content-center'>
                    <div className='img-fluid mb-4'>
                      <MachineGuestTagImage alt={currentMachine?.nomMaquina} getImage={getMachineTagNoAuth} param={currentMachine?._id} status={currentMachine?.foto_etiqueta_calibracion ? true : false} width={'500px'} height={'300px'} />
                    </div>
                  </div>
                </div>
              </div>
